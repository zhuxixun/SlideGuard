...
export function renderScanResult(state) {
  ...
  const r009Empty = state.r009EmptyWarning;
  ...
  return `
    ...
    ${r009Empty ? '<div class="info" style="margin-bottom:18px;color:#9b5b00;border-color:#f2c879;background:#fff9e8"><b>敏感词库为空</b>　敏感及残留文本检查已执行，但因词库为空未检测任何词条。未发现问题不代表无敏感内容，请前往<a href="#sensitive-words" style="color:#1f5eff;text-decoration:underline">敏感词库</a>添加词条后重新扫描。</div>' : ''}
